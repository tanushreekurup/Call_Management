...
<body style="background: url('images/bg18.jpg') no-repeat center fixed;height: 100%;background-position: center;background-repeat: no-repeat;background-size: cover;">
  ...
  <div class="container">
    <center><h1><span>A</span><span>s</span><span>s</span><span>i</span><span>g</span><span>n</span><span><pre> </pre></span><span>R</span><span>e</span><span>p</span><span>o</span><span>r</span><span>t</span></h1></center>
          ...
          <tr>
              <td  class="td5" style="padding-bottom: 2%;padding-top: 7%;">
                <div class="input-container">   
                  <input type="number" name="Call_ID">
                  <label style="margin-top: -1%;">Call ID:</label>
                </div>
              </td>
          </tr>
          <tr>
              <td  class="td5" style="padding-bottom: 2%;">
                <div class="input-container">   
                  <input type="text" name="Assign_employee_name">
                  <label style="margin-top: -1%;">Assign Employee Name:</label>
                </div>
              </td>
          </tr>
          <tr>
              <td  class="td5" style="padding-bottom: 2%;">
                  <div class="input-container">
                    ...
                    <label style="margin-top: -1%;">Status:</label>    
                  </div>
              </td>
          </tr>
          <tr>
              <td  class="td5">
                  <div class="input-container" style="padding-bottom: 2%;">
                    ...
                    <label style="margin-top: -1%;">Remark:</label>    
                  </div>
              </td>
          </tr>
          <tr>
