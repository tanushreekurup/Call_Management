...
<body style="background: url('images/bg18.jpg') no-repeat center fixed;height: 100%;background-position: center;background-repeat: no-repeat;background-size: cover;">
  ...
  <div class="container">
    <center><h1><span>A</span><span>d</span><span>d</span><span><pre> </pre></span><span>C</span><span>u</span><span>s</span><span>t</span><span>o</span><span>m</span><span>e</span><span>r</span></h1></center>
 ...
 <center>
    <form action="insert_customer.php" method="POST">
        <table cellspacing="0px" style="background-color:  rgba(240,248,255,.9);color: #002147;padding-bottom: 5%;">
          ...
          <tr>
              <td  class="td5" style="padding-top: 5%;padding-bottom: 2%;">
                  <div class="input-container">
                    <input type="number" name="Customer_id">
                    <label style="margin-top: -1%;">Customer ID:</label>    
                  </div>
              </td>
          </tr>
          <tr>
              <td  class="td5" style="padding-bottom: 2%;">
                <div class="input-container">   
                  <input type="text" name="Fm_name">
                  <label style="margin-top: -1%;">Firm Name:</label>
                </div>
              </td>
          </tr>
          <tr>
              <td  class="td5" style="padding-bottom: 2%;">
                  <div class="input-container">
                    ...
                    <label style="margin-top: -1%;">GST:</label>    
                  </div>
              </td>
          </tr>
          <tr>
          ...
          <tr>
              <td  class="td5" style="padding-bottom: 2%;">
                  <div class="input-container">
                    <input type="number" name="Phn_no1">
          ...
          <tr>
              <td  class="td5" style="padding-bottom: 2%;">
                  <div class="input-container">
                    <input type="number" name="Phn_no2">
          ...
          <tr>
              <td  class="td5" style="padding-bottom: 2%;">
                  <div class="input-container">
                    <input type="number" name="Totalpc">
                    <label style="margin-top: -1%;">Total PC:</label>    
                  </div>
              </td>
          </tr>
          <tr>
              <td  class="td5" style="padding-bottom: 2%;">
                  <div class="input-container">
                    <input type="number" name="Total_Laptop">
                    <label style="margin-top: -1%;">Total Laptop:</label>    
                  </div>
              </td>
          </tr>
          <tr>
              <td  class="td5" style="padding-bottom: 2%;">
                  <div class="input-container">
                    ...
                    <label style="margin-top: -1%;">Total CCTV:</label>    
                  </div>
              </td>
          </tr>
          <tr>
              <td  class="td5" style="padding-bottom: 2%;">
                  <div class="input-container">
                    ...
                    <label style="margin-top: -1%;">Google Map Link:</label>    
                  </div>
              </td>
          </tr>
          <tr>
