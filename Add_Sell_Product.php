...
<body style="background: url('images/bg18.jpg') no-repeat center fixed;height: 100%;background-position: center;background-repeat: no-repeat;background-size: cover;">
 ...
 <div class="container">
    <center><h1><span>A</span><span>d</span><span>d</span><span><pre> </pre></span><span>P</span><span>r</span><span>o</span><span>d</span><span>u</span><span>c</span><span>t</span><span><pre> </pre></span><span>D</span><span>e</span><span>t</span><span>a</span><span>i</span><span>l</span></h1></center>
 ...
 <center>
    <form>
        <table cellspacing="0px" style="background-color:  rgba(240,248,255,.9);color: #002147;padding-bottom: 5%;">
          ...
          <tr>
              <td  class="td5" style="padding-bottom: 2%;padding-top: 7%;">
                <div class="input-container">   
                  <input type="number" name="Product_ID">
                  <label style="margin-top: -1%;">Product ID:</label>
                </div>
              </td>
          </tr>
          <tr>
              <td  class="td5" style="padding-bottom: 2%;">
                <div class="input-container">   
                  ...
                  <label style="margin-top: -1%;">Product Name:</label>
                </div>
              </td>
          </tr>
          <tr>
              <td  class="td5" style="padding-bottom: 2%;">
                  <div class="input-container">
                    ...
                    <label style="margin-top: -1%;">Customer Name:</label>    
                  </div>
              </td>
          </tr>
          <tr>
              <td  class="td5">
                  <div class="input-container" style="padding-bottom: 2%;">
                    <input type="number" name="Validty">
                    <label style="margin-top: -1%;">Validity(in years):</label>    
                  </div>
              </td>
          </tr>
          <tr>
